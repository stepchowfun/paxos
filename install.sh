...
(
  ...
  if [ -n "${VERSION:-}" ]; then
    DOWNLOAD_URL="https://github.com/stepchowfun/paxos/releases/download/v$VERSION/$FILENAME"
  else
    DOWNLOAD_URL="https://github.com/stepchowfun/paxos/releases/latest/download/$FILENAME"
  fi
